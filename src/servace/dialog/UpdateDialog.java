...
public class UpdateDialog extends JFrame {
    ...
    public UpdateDialog(JFrame jf, String title, boolean isModel, ActionDoneListener listener, String id){
...
//        sexBox.add(Box.createHorizontalStrut(20));
        ...
        JLabel birLable = new JLabel("Birthday：");
...
//                String birthday = dateChooserJButton.getText().trim();
                ...
                int i = studentInfoDAO.update(
                        "update basicinformation set ID = ?,`Name` = ?,`password` = ?,Sex = ?,Phone = ?,birthday = ?,teacher = ? where ID = ?"
                        , id1, name, password, sex, phone, birthday, teacher,id1);
                ...
                if (i > 0){
                    ...
                    jta.setText("Failed，Please Input Again");
